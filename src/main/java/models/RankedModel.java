...
//            System.out.println(currentInputProgram.getText());
...
//        System.out.println(defeasibleRanks.get(rankCounter-1).toRepresentationString());
//        System.out.println(defeasibleRanks.get(rankCounter).toRepresentationString());
